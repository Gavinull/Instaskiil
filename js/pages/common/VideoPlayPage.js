...
// import { View, Text, Slider, TextInput, StyleSheet, Platform, Dimensions, TouchableOpacity, PanResponder, ImageBackground, Image, ScrollView, RefreshControl, ListView, Modal } from 'react-native';
...
//                 <Video style={{ position: 'absolute',top: 0,left: 0, bottom: 0, right: 0, backgroundColor: '#f0f0f0'}} 
//                     source={{uri:this.state.url?this.state.url:"http://rs.majiawei.com/"}}
//                     resizeMode="cover"
//                     ref={(ref) => {
//                         this.player = ref;
//                     }}
...
//                     />
//                     {
//                         this.state.paused ? ( <TouchableOpacity style={{height:80, width:80,alignItems:'center',justifyContent: 'center'}}
//                             onPress={() => {
...
export default class VideoPlayScreen extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      videoHeight: screenWidth * (16/9), // 默认16：9的宽高比
    ...
    return (
      <View style={styles.container} onLayout={this._onLayout}>
                ...
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                    <Image
                      ...
                      source={require('../../resources/img/icon_video_play.png')}
                    />
              ...
              <View style={[styles.control, {width: this.state.videoWidth}]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress() }}>
                  <Image
                    ...
                    source={this.state.isPlaying ? require('../../resources/img/icon_control_pause.png') : require('../../resources/img/icon_control_play.png')}
                  />
                </TouchableOpacity>
                ...
                <Slider
                  ...
                  thumbImage={require('../../resources/img/icon_control_slider.png')}
                ...
                {/* <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlShrinkPress() }}>
                  <Image
                    ...
                    source={this.state.isFullScreen ? require('../../resources/img/icon_control_shrink_screen.png') : require('../../resources/img/icon_control_full_screen.png')}
                  />
                </TouchableOpacity> */}
              </View> : null
          }
        ...
        <View style={{flex: 1, alignItems:'center', justifyContent:'center'}}>
          ...
          <View style={{position:'absolute',top:20,left:10,justifyContent:'center',alignItems:'center'}}>
              <TouchableOpacity style={{height:30,width:30,justifyContent:'center',alignItems:'center'}} 
                             onPress={() => {
                              Actions.pop();
                      }}>
                 <Image style={{width:30, height:30,resizeMode:'contain'}} source={require('../../resources/img/icon_close_white.png')}/>
              </TouchableOpacity>
            </View>
