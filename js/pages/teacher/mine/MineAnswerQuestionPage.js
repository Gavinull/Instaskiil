...
import { MineAnswerQuestionPageStore } from '../../../stores/teacher/UserStore.teacher';

const { width, height } = Dimensions.get('window');
 
@observer
export default class MineAnswerQuestionPage extends React.Component{

        constructor(props){
            super(props);
            this.state = { currentIndex:2 };
            this.pageStore = new MineAnswerQuestionPageStore();
        }
        ...
        renderContentView(){
            ...
            let {
                 ...
                 underwayListDataSource, 
                 completedListDataSource,
                 is_invitation_Refreshing, 
                 is_underway_Refreshing,
                 is_completed_Refreshing
             } =  this.pageStore;
            let list = [
                ...
                {name:'已完成', data:completedListDataSource, refresh:is_completed_Refreshing},
            ];
            return (
                <ScrollableTabView
                        ...
                        onChangeTab={(obj) => {
                            this.state.currentIndex = obj.i+2;
                            this.pageStore.changeListDataSource(obj.i+2, false);} 
                            }> 
                        {
